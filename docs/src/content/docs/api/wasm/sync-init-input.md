...
<div><dt>Source</dt><dd><code>packages/wasm/pkg/sheetwrite_wasm.d.ts#L517</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="export type SyncInitInput = BufferSource | WebAssembly.Module;" data-pagefind-ignore>Copy</button>
