...
<button class="api-copy" type="button" data-copy-code="export type InitInput =&#10;  RequestInfo | URL | Response | BufferSource | WebAssembly.Module;" data-pagefind-ignore>Copy</button>
