...
description: "Build the active-sheet table model used by the bounded OOXML writer."
---
...
<div><dt>Source</dt><dd><code>packages/xlsx/src/table-export.ts#L31</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="function buildXlsxModel(&#10;  workbook: Workbook,&#10;  store: Store,&#10;  options?: XlsxWorkbookOptions,&#10;): XlsxModel | null" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>buildXlsxModel</code></p>
