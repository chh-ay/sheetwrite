...
<div><dt>Source</dt><dd><code>packages/core/src/adapter.ts#L169</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="function gridSizeStyle(&#10;  size: OptionalGridSizeProps,&#10;): Record&lt;string, string&gt;" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>gridSizeStyle</code></p>
