---
title: "SheetwriteErrorCode | @sheetwrite/core/adapter"
description: "Exhaustive stable discriminator for consumer-visible Sheetwrite failures."
---
<!-- api-export:@sheetwrite/core|./adapter|SheetwriteErrorCode -->
...
<div><dt>Source</dt><dd><code>packages/core/src/errors.ts#L53</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="export type SheetwriteErrorCode = (typeof SHEETWRITE_ERROR_CODES)[number];" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>SheetwriteErrorCode</code></p>
