...
<details class="api-member" id="optional-grid-size-props-height" data-pagefind-weight="1" open>
...
<details class="api-member" id="optional-grid-size-props-fill" data-pagefind-weight="1" open>
...
<button class="api-copy" type="button" data-copy-code="export interface OptionalGridSizeProps {&#10;  height?: number | string;&#10;  fill?: true;&#10;}" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>OptionalGridSizeProps</code></p>

<ul class="api-consumer-list">
<li><a href="/docs/api/core-adapter/grid-size-style/"><code>gridSizeStyle</code></a><span class="api-consumer-kind">@sheetwrite/core</span></li>
</ul>
</div>
