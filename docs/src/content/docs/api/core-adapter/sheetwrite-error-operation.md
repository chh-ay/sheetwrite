---
title: "SheetwriteErrorOperation | @sheetwrite/core/adapter"
description: "Exhaustive stable operation discriminator for consumer-visible failures."
---
<!-- api-export:@sheetwrite/core|./adapter|SheetwriteErrorOperation -->
...
<div><dt>Source</dt><dd><code>packages/core/src/errors.ts#L82</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="export type SheetwriteErrorOperation =&#10;  (typeof SHEETWRITE_ERROR_OPERATIONS)[number];" data-pagefind-ignore>Copy</button>
