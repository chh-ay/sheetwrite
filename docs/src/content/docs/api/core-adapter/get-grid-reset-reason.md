...
<div><dt>Source</dt><dd><code>packages/core/src/adapter.ts#L192</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="function getGridResetReason(&#10;  previous: GridOptions,&#10;  next: GridOptions,&#10;): GridResetReason | null" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>getGridResetReason</code></p>
