...
<button class="api-copy" type="button" data-copy-code="function resolveHyperlinkTarget(&#10;  workbook: Workbook,&#10;  target: HyperlinkTarget,&#10;): ResolvedHyperlinkTarget" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>resolveHyperlinkTarget</code></p>
