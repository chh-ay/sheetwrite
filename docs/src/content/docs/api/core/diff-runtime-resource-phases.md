...
<button class="api-copy" type="button" data-copy-code="function diffRuntimeResourcePhases(&#10;  before: RuntimeResourceSnapshot,&#10;  after: RuntimeResourceSnapshot,&#10;): RuntimeResourcePhaseDelta" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>diffRuntimeResourcePhases</code></p>
