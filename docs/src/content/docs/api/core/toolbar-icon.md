...
<div><dt>Source</dt><dd><code>packages/core/src/types/grid.ts#L199</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="export type ToolbarIcon = string | Node | (() =&gt; Node);" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>ToolbarIcon</code></p>
