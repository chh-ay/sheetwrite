...
<button class="api-copy" type="button" data-copy-code="{ ok: true; name: string }" data-pagefind-ignore>Copy</button>
...
<button class="api-copy" type="button" data-copy-code="{ ok: false; code: WorkbookTableNameIssueCode }" data-pagefind-ignore>Copy</button>
...
<button class="api-copy" type="button" data-copy-code="export type WorkbookTableNameValidationResult =&#10;  | {&#10;      ok: true;&#10;      name: string;&#10;    }&#10;  | {&#10;      ok: false;&#10;      code: WorkbookTableNameIssueCode;&#10;    };" data-pagefind-ignore>Copy</button>
