...
<div><dt>Source</dt><dd><code>packages/core/src/export.ts#L359</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="function setXlsxTableImportBackend(&#10;  next: XlsxTableImportBackend,&#10;): void" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>setXlsxTableImportBackend</code></p>
