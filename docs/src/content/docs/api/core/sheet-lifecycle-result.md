...
<div><dt>Source</dt><dd><code>packages/core/src/types/grid.ts#L434</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="export type SheetLifecycleResult = ApplyTransactionResult &amp; {&#10;  readonly sheet: SheetId;&#10;};" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>SheetLifecycleResult</code></p>
