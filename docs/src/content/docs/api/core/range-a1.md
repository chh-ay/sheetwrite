...
<button class="api-copy" type="button" data-copy-code="function rangeA1(a: CellRef, b: CellRef): string" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>rangeA1</code></p>
