...
<button class="api-copy" type="button" data-copy-code="export type RowData = Record&lt;string, DataCell&gt;;" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>RowData</code></p>

<ul class="api-consumer-list">
<li><a href="/docs/api/core/data-source-page/"><code>DataSourcePage</code></a><span class="api-consumer-kind">@sheetwrite/core</span></li>
<li><a href="/docs/api/core/legacy-row-page/"><code>LegacyRowPage</code></a><span class="api-consumer-kind">@sheetwrite/core</span></li>
