...
<details class="api-member" id="comment-coordinator-options-document-id" data-pagefind-weight="1" open>
...
<details class="api-member" id="comment-coordinator-options-server-version" data-pagefind-weight="1" open>
...
<button class="api-copy" type="button" data-copy-code="export interface CommentCoordinatorOptions {&#10;  documentId: string;&#10;  serverVersion?: number;&#10;}" data-pagefind-ignore>Copy</button>
