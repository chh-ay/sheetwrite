...
<button class="api-copy" type="button" data-copy-code="function colToA1(col: number): string" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>colToA1</code></p>
