...
<button class="api-copy" type="button" data-copy-code="const DEFAULT_TRANSACTION_RESOURCE_LIMITS: Readonly&lt;TransactionResourceLimits&gt;" data-pagefind-ignore>Copy</button>
