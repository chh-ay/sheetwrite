...
<details class="api-member" id="cell-note-addr" data-pagefind-weight="1" open>
...
<details class="api-member" id="cell-note-text" data-pagefind-weight="1" open>
<summary><code>text</code></summary>

<button class="api-copy" type="button" data-copy-code="text: string;" data-pagefind-ignore>Copy</button>
...
<button class="api-copy" type="button" data-copy-code="export interface CellNote {&#10;  addr: CellAddress;&#10;  text: string;&#10;}" data-pagefind-ignore>Copy</button>
