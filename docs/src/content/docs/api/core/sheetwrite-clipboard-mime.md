...
<button class="api-copy" type="button" data-copy-code="const SHEETWRITE_CLIPBOARD_MIME: &quot;application/x-sheetwrite+json&quot;" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>SHEETWRITE_CLIPBOARD_MIME</code></p>
