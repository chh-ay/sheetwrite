...
<div><dt>Source</dt><dd><code>packages/core/src/grid.ts#L254</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="const DEFAULT_THEME: Theme" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>DEFAULT_THEME</code></p>
