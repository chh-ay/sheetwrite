...
<div><dt>Source</dt><dd><code>packages/core/src/resource-accounting.ts#L311</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="function emptyStoreMemoryStats(&#10;  wasmCommittedBytes: number | null,&#10;): StoreMemoryBreakdown" data-pagefind-ignore>Copy</button>
