...
<button class="api-copy" type="button" data-copy-code="export type ContextMenuItems =&#10;  | readonly ContextMenuItem[]&#10;  | ((context: ContextMenuContext) =&gt; readonly ContextMenuItem[]);" data-pagefind-ignore>Copy</button>
