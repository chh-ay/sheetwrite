...
<div><dt>Source</dt><dd><code>packages/core/src/document-protocol.ts#L2706</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="function validateWorkbookSnapshot(&#10;  input: unknown,&#10;  options?: SnapshotValidationOptions,&#10;): DocumentValidationResult" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>validateWorkbookSnapshot</code></p>
