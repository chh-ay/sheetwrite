---
title: "GridCommandName | @sheetwrite/svelte"
description: "Built-in command names accepted by state queries and change events."
---
<!-- api-export:@sheetwrite/svelte|.|GridCommandName -->
...
<div><dt>Source</dt><dd><code>packages/core/dist/types/grid.d.ts#L105</code></dd></div>
</dl>
...
<button class="api-copy" type="button" data-copy-code="export type GridCommandName = Exclude&lt;ToolbarActionName, &quot;separator&quot;&gt;;" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>GridCommandName</code></p>
