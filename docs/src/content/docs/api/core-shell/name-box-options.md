...
<details class="api-member" id="name-box-options-focus-grid" data-pagefind-weight="1" open>
...
<details class="api-member" id="name-box-options-label" data-pagefind-weight="1" open>
...
<button class="api-copy" type="button" data-copy-code="export interface NameBoxOptions {&#10;  focusGrid?: () =&gt; void;&#10;  label?: string;&#10;}" data-pagefind-ignore>Copy</button>
