...
<button class="api-copy" type="button" data-copy-code="function describeSelection(selection: Selection | null): string" data-pagefind-ignore>Copy</button>
...
<p class="api-consumers-label">Public exports naming <code>describeSelection</code></p>
